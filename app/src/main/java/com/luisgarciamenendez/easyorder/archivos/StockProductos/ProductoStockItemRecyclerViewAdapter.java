...
public class ProductoStockItemRecyclerViewAdapter extends RecyclerView.Adapter<ProductoStockItemRecyclerViewAdapter.ViewHolder> {

    private List<DishesContainer.Dish> dishList;
    private final ProductoStockItemFragment.OnListFragmentInteractionListener mListener;
    private Context context;
    private List<ViewHolder> viewHolderList;

    public ProductoStockItemRecyclerViewAdapter(DishesContainer dishesContainer, ProductoStockItemFragment.OnListFragmentInteractionListener listener, Context context) {
