...
import com.luisgarciamenendez.easyorder.archivos.NuevoPedido.ProductoItemFragment.OnListFragmentInteractionListener;
...
public class ProductoRecyclerViewAdapter extends RecyclerView.Adapter<ProductoRecyclerViewAdapter.DishViewHolder> {
    ...
    public ProductoRecyclerViewAdapter(OnListFragmentInteractionListener listener, Context context) {
...
//                setPosition(holder.getPosition());
    ...
    public class DishViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        public void updateOrderedProduct(){
            stock -= quantity;
            dish.stock = stock;
            String cantidad = Integer.toString(quantity);
